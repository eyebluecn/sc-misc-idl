...
func (p *ColumnOmnibusRequest) FastReadField4(buf []byte) (int, error) {
	offset := 0
...
func (p *ColumnOmnibusRequest) fastWriteField4(buf []byte, binaryWriter bthrift.BinaryWriter) int {
	offset := 0
	offset += bthrift.Binary.WriteFieldBegin(buf[offset:], "operator", thrift.STRUCT, 4)
...
func (p *ColumnOmnibusRequest) field4Length() int {
	l := 0
	l += bthrift.Binary.FieldBeginLength("operator", thrift.STRUCT, 4)
...
func (p *ColumnQueryByIdRequest) FastRead(buf []byte) (int, error) {
	var err error
	var offset int
	var l int
	var fieldTypeId thrift.TType
...
ReadFieldBeginError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_ColumnQueryByIdRequest[fieldId]), err)
SkipFieldError:
	return offset, thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
ReadFieldEndError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field end error", p), err)
...
func (p *ColumnQueryByIdRequest) FastReadField1(buf []byte) (int, error) {
	offset := 0
...
func (p *ColumnQueryByIdRequest) FastReadField255(buf []byte) (int, error) {
	offset := 0
...
// for compatibility
func (p *ColumnQueryByIdRequest) FastWrite(buf []byte) int {
	return 0
}

func (p *ColumnQueryByIdRequest) FastWriteNocopy(buf []byte, binaryWriter bthrift.BinaryWriter) int {
	offset := 0
	offset += bthrift.Binary.WriteStructBegin(buf[offset:], "ColumnQueryByIdRequest")
	if p != nil {
		offset += p.fastWriteField1(buf[offset:], binaryWriter)
		offset += p.fastWriteField255(buf[offset:], binaryWriter)
	}
...
func (p *ColumnQueryByIdRequest) BLength() int {
	l := 0
	l += bthrift.Binary.StructBeginLength("ColumnQueryByIdRequest")
	if p != nil {
		l += p.field1Length()
		l += p.field255Length()
	}
...
func (p *ColumnQueryByIdRequest) fastWriteField1(buf []byte, binaryWriter bthrift.BinaryWriter) int {
	offset := 0
...
func (p *ColumnQueryByIdRequest) fastWriteField255(buf []byte, binaryWriter bthrift.BinaryWriter) int {
	offset := 0
	if p.IsSetBase() {
		offset += bthrift.Binary.WriteFieldBegin(buf[offset:], "base", thrift.STRUCT, 255)
		offset += p.Base.FastWriteNocopy(buf[offset:], binaryWriter)
...
func (p *ColumnQueryByIdRequest) field1Length() int {
	l := 0
...
func (p *ColumnQueryByIdRequest) field255Length() int {
	l := 0
	if p.IsSetBase() {
		l += bthrift.Binary.FieldBeginLength("base", thrift.STRUCT, 255)
		l += p.Base.BLength()
...
func (p *ColumnQueryByIdResponse) FastRead(buf []byte) (int, error) {
	var err error
	var offset int
	var l int
	var fieldTypeId thrift.TType
...
ReadFieldBeginError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_ColumnQueryByIdResponse[fieldId]), err)
SkipFieldError:
	return offset, thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
ReadFieldEndError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field end error", p), err)
...
func (p *ColumnQueryByIdResponse) FastReadField1(buf []byte) (int, error) {
	offset := 0
...
func (p *ColumnQueryByIdResponse) FastReadField255(buf []byte) (int, error) {
	offset := 0
...
// for compatibility
func (p *ColumnQueryByIdResponse) FastWrite(buf []byte) int {
	return 0
}

func (p *ColumnQueryByIdResponse) FastWriteNocopy(buf []byte, binaryWriter bthrift.BinaryWriter) int {
	offset := 0
	offset += bthrift.Binary.WriteStructBegin(buf[offset:], "ColumnQueryByIdResponse")
	if p != nil {
		offset += p.fastWriteField1(buf[offset:], binaryWriter)
		offset += p.fastWriteField255(buf[offset:], binaryWriter)
	}
...
func (p *ColumnQueryByIdResponse) BLength() int {
	l := 0
	l += bthrift.Binary.StructBeginLength("ColumnQueryByIdResponse")
	if p != nil {
		l += p.field1Length()
		l += p.field255Length()
	}
...
func (p *ColumnQueryByIdResponse) fastWriteField1(buf []byte, binaryWriter bthrift.BinaryWriter) int {
	offset := 0
...
func (p *ColumnQueryByIdResponse) fastWriteField255(buf []byte, binaryWriter bthrift.BinaryWriter) int {
	offset := 0
	offset += bthrift.Binary.WriteFieldBegin(buf[offset:], "baseResp", thrift.STRUCT, 255)
	offset += p.BaseResp.FastWriteNocopy(buf[offset:], binaryWriter)
	offset += bthrift.Binary.WriteFieldEnd(buf[offset:])
...
func (p *ColumnQueryByIdResponse) field1Length() int {
	l := 0
...
func (p *ColumnQueryByIdResponse) field255Length() int {
	l := 0
	l += bthrift.Binary.FieldBeginLength("baseResp", thrift.STRUCT, 255)
	l += p.BaseResp.BLength()
	l += bthrift.Binary.FieldEndLength()
...
func (p *ColumnQueryByIdsRequest) FastRead(buf []byte) (int, error) {
	var err error
	var offset int
	var l int
	var fieldTypeId thrift.TType
...
ReadFieldBeginError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_ColumnQueryByIdsRequest[fieldId]), err)
SkipFieldError:
	return offset, thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
ReadFieldEndError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field end error", p), err)
...
func (p *ColumnQueryByIdsRequest) FastReadField1(buf []byte) (int, error) {
	offset := 0
...
func (p *ColumnQueryByIdsRequest) FastReadField255(buf []byte) (int, error) {
	offset := 0
...
// for compatibility
func (p *ColumnQueryByIdsRequest) FastWrite(buf []byte) int {
	return 0
}

func (p *ColumnQueryByIdsRequest) FastWriteNocopy(buf []byte, binaryWriter bthrift.BinaryWriter) int {
	offset := 0
	offset += bthrift.Binary.WriteStructBegin(buf[offset:], "ColumnQueryByIdsRequest")
	if p != nil {
		offset += p.fastWriteField1(buf[offset:], binaryWriter)
		offset += p.fastWriteField255(buf[offset:], binaryWriter)
	}
...
func (p *ColumnQueryByIdsRequest) BLength() int {
	l := 0
	l += bthrift.Binary.StructBeginLength("ColumnQueryByIdsRequest")
	if p != nil {
		l += p.field1Length()
		l += p.field255Length()
	}
...
func (p *ColumnQueryByIdsRequest) fastWriteField1(buf []byte, binaryWriter bthrift.BinaryWriter) int {
	offset := 0
	offset += bthrift.Binary.WriteFieldBegin(buf[offset:], "columnIds", thrift.LIST, 1)
	listBeginOffset := offset
...
func (p *ColumnQueryByIdsRequest) fastWriteField255(buf []byte, binaryWriter bthrift.BinaryWriter) int {
	offset := 0
	if p.IsSetBase() {
		offset += bthrift.Binary.WriteFieldBegin(buf[offset:], "base", thrift.STRUCT, 255)
		offset += p.Base.FastWriteNocopy(buf[offset:], binaryWriter)
...
func (p *ColumnQueryByIdsRequest) field1Length() int {
	l := 0
	l += bthrift.Binary.FieldBeginLength("columnIds", thrift.LIST, 1)
...
func (p *ColumnQueryByIdsRequest) field255Length() int {
	l := 0
	if p.IsSetBase() {
		l += bthrift.Binary.FieldBeginLength("base", thrift.STRUCT, 255)
		l += p.Base.BLength()
...
func (p *ColumnQueryByIdsResponse) FastRead(buf []byte) (int, error) {
	var err error
	var offset int
	var l int
	var fieldTypeId thrift.TType
...
ReadFieldBeginError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_ColumnQueryByIdsResponse[fieldId]), err)
SkipFieldError:
	return offset, thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
ReadFieldEndError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field end error", p), err)
...
func (p *ColumnQueryByIdsResponse) FastReadField1(buf []byte) (int, error) {
	offset := 0
...
func (p *ColumnQueryByIdsResponse) FastReadField255(buf []byte) (int, error) {
	offset := 0
...
// for compatibility
func (p *ColumnQueryByIdsResponse) FastWrite(buf []byte) int {
	return 0
}

func (p *ColumnQueryByIdsResponse) FastWriteNocopy(buf []byte, binaryWriter bthrift.BinaryWriter) int {
	offset := 0
	offset += bthrift.Binary.WriteStructBegin(buf[offset:], "ColumnQueryByIdsResponse")
	if p != nil {
		offset += p.fastWriteField1(buf[offset:], binaryWriter)
		offset += p.fastWriteField255(buf[offset:], binaryWriter)
	}
...
func (p *ColumnQueryByIdsResponse) BLength() int {
	l := 0
	l += bthrift.Binary.StructBeginLength("ColumnQueryByIdsResponse")
	if p != nil {
		l += p.field1Length()
		l += p.field255Length()
	}
...
func (p *ColumnQueryByIdsResponse) fastWriteField1(buf []byte, binaryWriter bthrift.BinaryWriter) int {
	offset := 0
	offset += bthrift.Binary.WriteFieldBegin(buf[offset:], "data", thrift.LIST, 1)
	listBeginOffset := offset
	offset += bthrift.Binary.ListBeginLength(thrift.STRUCT, 0)
...
func (p *ColumnQueryByIdsResponse) fastWriteField255(buf []byte, binaryWriter bthrift.BinaryWriter) int {
	offset := 0
	offset += bthrift.Binary.WriteFieldBegin(buf[offset:], "baseResp", thrift.STRUCT, 255)
	offset += p.BaseResp.FastWriteNocopy(buf[offset:], binaryWriter)
	offset += bthrift.Binary.WriteFieldEnd(buf[offset:])
...
func (p *ColumnQueryByIdsResponse) field1Length() int {
	l := 0
	l += bthrift.Binary.FieldBeginLength("data", thrift.LIST, 1)
	l += bthrift.Binary.ListBeginLength(thrift.STRUCT, len(p.Data))
	for _, v := range p.Data {
...
func (p *ColumnQueryByIdsResponse) field255Length() int {
	l := 0
	l += bthrift.Binary.FieldBeginLength("baseResp", thrift.STRUCT, 255)
	l += p.BaseResp.BLength()
	l += bthrift.Binary.FieldEndLength()
