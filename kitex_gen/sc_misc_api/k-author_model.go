...
ReadFieldError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_AuthorDTO[fieldId]), err)
SkipFieldError:
...
func (p *AuthorDTO) FastWriteNocopy(buf []byte, binaryWriter bthrift.BinaryWriter) int {
	offset := 0
	offset += bthrift.Binary.WriteStructBegin(buf[offset:], "AuthorDTO")
	if p != nil {
...
func (p *AuthorDTO) BLength() int {
	l := 0
	l += bthrift.Binary.StructBeginLength("AuthorDTO")
	if p != nil {
		l += p.field1Length()
		l += p.field2Length()
		l += p.field3Length()
...
func (p *AuthorDTO) fastWriteField1(buf []byte, binaryWriter bthrift.BinaryWriter) int {
	offset := 0
...
func (p *AuthorDTO) fastWriteField2(buf []byte, binaryWriter bthrift.BinaryWriter) int {
	offset := 0
...
func (p *AuthorDTO) fastWriteField3(buf []byte, binaryWriter bthrift.BinaryWriter) int {
	offset := 0
...
func (p *AuthorDTO) fastWriteField4(buf []byte, binaryWriter bthrift.BinaryWriter) int {
	offset := 0
...
func (p *AuthorDTO) fastWriteField5(buf []byte, binaryWriter bthrift.BinaryWriter) int {
	offset := 0
	offset += bthrift.Binary.WriteFieldBegin(buf[offset:], "realname", thrift.STRING, 5)
...
func (p *AuthorDTO) field1Length() int {
	l := 0
...
func (p *AuthorDTO) field2Length() int {
	l := 0
...
func (p *AuthorDTO) field3Length() int {
	l := 0
...
func (p *AuthorDTO) field4Length() int {
	l := 0
...
func (p *AuthorDTO) field5Length() int {
	l := 0
	l += bthrift.Binary.FieldBeginLength("realname", thrift.STRING, 5)
