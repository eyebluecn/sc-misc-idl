...
type ReaderQueryByIdsRequest struct {
	ReaderIds []int64            `thrift:"readerIds,1" frugal:"1,default,list<i64>" json:"readerIds"`
	Base      *sc_misc_base.Base `thrift:"base,255,optional" frugal:"255,optional,sc_misc_base.Base" json:"base,omitempty"`
}

func NewReaderQueryByIdsRequest() *ReaderQueryByIdsRequest {
	return &ReaderQueryByIdsRequest{}
}

func (p *ReaderQueryByIdsRequest) InitDefault() {
	*p = ReaderQueryByIdsRequest{}
}

func (p *ReaderQueryByIdsRequest) GetReaderIds() (v []int64) {
	return p.ReaderIds
}

var ReaderQueryByIdsRequest_Base_DEFAULT *sc_misc_base.Base

func (p *ReaderQueryByIdsRequest) GetBase() (v *sc_misc_base.Base) {
	if !p.IsSetBase() {
		return ReaderQueryByIdsRequest_Base_DEFAULT
	}
	return p.Base
}
func (p *ReaderQueryByIdsRequest) SetReaderIds(val []int64) {
	p.ReaderIds = val
}
func (p *ReaderQueryByIdsRequest) SetBase(val *sc_misc_base.Base) {
	p.Base = val
}

var fieldIDToName_ReaderQueryByIdsRequest = map[int16]string{
	1:   "readerIds",
	255: "base",
}

func (p *ReaderQueryByIdsRequest) IsSetBase() bool {
	return p.Base != nil
}

func (p *ReaderQueryByIdsRequest) Read(iprot thrift.TProtocol) (err error) {
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_ReaderQueryByIdsRequest[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
func (p *ReaderQueryByIdsRequest) ReadField1(iprot thrift.TProtocol) error {
...
func (p *ReaderQueryByIdsRequest) ReadField255(iprot thrift.TProtocol) error {
	_field := sc_misc_base.NewBase()
	if err := _field.Read(iprot); err != nil {
		return err
	}
...
func (p *ReaderQueryByIdsRequest) Write(oprot thrift.TProtocol) (err error) {
	var fieldId int16
	if err = oprot.WriteStructBegin("ReaderQueryByIdsRequest"); err != nil {
		goto WriteStructBeginError
	}
	if p != nil {
		if err = p.writeField1(oprot); err != nil {
...
func (p *ReaderQueryByIdsRequest) writeField1(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("readerIds", thrift.LIST, 1); err != nil {
		goto WriteFieldBeginError
	}
	if err := oprot.WriteListBegin(thrift.I64, len(p.ReaderIds)); err != nil {
		return err
	}
...
func (p *ReaderQueryByIdsRequest) writeField255(oprot thrift.TProtocol) (err error) {
	if p.IsSetBase() {
		if err = oprot.WriteFieldBegin("base", thrift.STRUCT, 255); err != nil {
			goto WriteFieldBeginError
		}
...
func (p *ReaderQueryByIdsRequest) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("ReaderQueryByIdsRequest(%+v)", *p)

}

func (p *ReaderQueryByIdsRequest) DeepEqual(ano *ReaderQueryByIdsRequest) bool {
	if p == ano {
		return true
	} else if p == nil || ano == nil {
		return false
	}
	if !p.Field1DeepEqual(ano.ReaderIds) {
		return false
	}
	if !p.Field255DeepEqual(ano.Base) {
		return false
...
func (p *ReaderQueryByIdsRequest) Field1DeepEqual(src []int64) bool {

	if len(p.ReaderIds) != len(src) {
		return false
	}
	for i, v := range p.ReaderIds {
		_src := src[i]
		if v != _src {
			return false
		}
...
func (p *ReaderQueryByIdsRequest) Field255DeepEqual(src *sc_misc_base.Base) bool {
...
type ReaderQueryByIdsResponse struct {
	Data     []*ReaderDTO           `thrift:"data,1" frugal:"1,default,list<ReaderDTO>" json:"data"`
	BaseResp *sc_misc_base.BaseResp `thrift:"baseResp,255" frugal:"255,default,sc_misc_base.BaseResp" json:"baseResp"`
}

func NewReaderQueryByIdsResponse() *ReaderQueryByIdsResponse {
	return &ReaderQueryByIdsResponse{}
}

func (p *ReaderQueryByIdsResponse) InitDefault() {
	*p = ReaderQueryByIdsResponse{}
}

func (p *ReaderQueryByIdsResponse) GetData() (v []*ReaderDTO) {
	return p.Data
}

var ReaderQueryByIdsResponse_BaseResp_DEFAULT *sc_misc_base.BaseResp

func (p *ReaderQueryByIdsResponse) GetBaseResp() (v *sc_misc_base.BaseResp) {
	if !p.IsSetBaseResp() {
		return ReaderQueryByIdsResponse_BaseResp_DEFAULT
	}
	return p.BaseResp
}
func (p *ReaderQueryByIdsResponse) SetData(val []*ReaderDTO) {
	p.Data = val
}
func (p *ReaderQueryByIdsResponse) SetBaseResp(val *sc_misc_base.BaseResp) {
	p.BaseResp = val
}

var fieldIDToName_ReaderQueryByIdsResponse = map[int16]string{
	1:   "data",
	255: "baseResp",
}

func (p *ReaderQueryByIdsResponse) IsSetBaseResp() bool {
	return p.BaseResp != nil
}

func (p *ReaderQueryByIdsResponse) Read(iprot thrift.TProtocol) (err error) {
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_ReaderQueryByIdsResponse[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
func (p *ReaderQueryByIdsResponse) ReadField1(iprot thrift.TProtocol) error {
	_, size, err := iprot.ReadListBegin()
	if err != nil {
		return err
	}
	_field := make([]*ReaderDTO, 0, size)
	values := make([]ReaderDTO, size)
	for i := 0; i < size; i++ {
		_elem := &values[i]
...
func (p *ReaderQueryByIdsResponse) ReadField255(iprot thrift.TProtocol) error {
	_field := sc_misc_base.NewBaseResp()
	if err := _field.Read(iprot); err != nil {
		return err
	}
...
func (p *ReaderQueryByIdsResponse) Write(oprot thrift.TProtocol) (err error) {
	var fieldId int16
	if err = oprot.WriteStructBegin("ReaderQueryByIdsResponse"); err != nil {
		goto WriteStructBeginError
	}
	if p != nil {
		if err = p.writeField1(oprot); err != nil {
...
func (p *ReaderQueryByIdsResponse) writeField1(oprot thrift.TProtocol) (err error) {
...
func (p *ReaderQueryByIdsResponse) writeField255(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("baseResp", thrift.STRUCT, 255); err != nil {
		goto WriteFieldBeginError
	}
	if err := p.BaseResp.Write(oprot); err != nil {
...
func (p *ReaderQueryByIdsResponse) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("ReaderQueryByIdsResponse(%+v)", *p)

}

func (p *ReaderQueryByIdsResponse) DeepEqual(ano *ReaderQueryByIdsResponse) bool {
	if p == ano {
		return true
	} else if p == nil || ano == nil {
		return false
...
func (p *ReaderQueryByIdsResponse) Field1DeepEqual(src []*ReaderDTO) bool {
...
func (p *ReaderQueryByIdsResponse) Field255DeepEqual(src *sc_misc_base.BaseResp) bool {
