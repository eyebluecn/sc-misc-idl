...
import (
	"code.howimetmrright.com/smart-classroom/sc-misc-idl/kitex_gen/base"
	"context"
	"fmt"
...
type MyReq struct {
	...
	BaseReq *base.BaseReq `thrift:"baseReq,2,required" frugal:"2,required,base.BaseReq" json:"baseReq"`
}
...
var MyReq_BaseReq_DEFAULT *base.BaseReq

func (p *MyReq) GetBaseReq() (v *base.BaseReq) {
	if !p.IsSetBaseReq() {
...
func (p *MyReq) SetBaseReq(val *base.BaseReq) {
	p.BaseReq = val
}
...
func (p *MyReq) Field2DeepEqual(src *base.BaseReq) bool {
